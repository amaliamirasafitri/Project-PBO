...
public class DatabaseConnection {
    ...
    private static void initDatabase() {
        ...
        // Buat tabel paket jika belum ada dan isi data awal
        ...
        try (Connection conn = DriverManager.getConnection(URL, USER, PASS); Statement stmt = conn.createStatement()) {
            ...
            // Insert default paket jika tabel kosong
            ...
            if (count == 0) {
                String insert = "INSERT INTO paket (nama_paket, deskripsi_singkat, fitur, durasi, harga) VALUES "
                        + "('Paket Bronze (1 Jam)', 'Cocok buat kamu yang cuma ingin main sebentar atau sekadar mengisi waktu luang.', '• 1 jam bermain\\n• Bebas pilih game\\n• Kontrol PC\\n• Headset & sofa nyaman', 1, 12000),"
                        + "('Paket Silver (3 Jam)', 'Pilihan pas untuk sesi bermain lebih lama tanpa khawatir waktu cepat habis.', '• 3 jam bermain\\n• Game kapan saja\\n• Konsol & mesin ringan\\n• WIFI gratis & ruangan ber-AC', 3, 30000),"
                        + "('Paket Gold (5 Jam)', 'Buat kamu yang mau puas main game favorit tanpa batas waktu yang mepet!', '• 5 jam bermain\\n• Akses semua game premium\\n• 1 minuman gratis\\n• Prioritas room', 5, 50000),"
                        + "('Paket Malam', 'Spesial untuk gamer malam yang mau suasana tenang dan bebas ngetes.', '• Bermain nonstop jam 00:00-06:00\\n• Snack & minuman gratis\\n• Ruang nyaman dengan lampu redup\\n• Diskon untuk member', 6, 60000)";
        ...
        // Isi tabel PC dengan data contoh jika kosong (misal PC1..PC10)
        try (Connection conn = DriverManager.getConnection(URL, USER, PASS); Statement stmt = conn.createStatement()) {
    ...
    /**
     * Reusable helper untuk mendapatkan koneksi ke database aplikasi. Digunakan
     * oleh DAO lain seperti PaketDAO.
     */
    ...
    /**
     * Ambil semua paket dari tabel paket dan kembalikan sebagai list PaketData.
     * Digunakan langsung oleh UI (mis. PaketPanel) agar tidak butuh DAO
     * terpisah.
     */
    ...
    /**
     * Representasi data paket yang dikembalikan dari database.
     */
    public static class PaketData {
        ...
        public PaketData(int paketId, String namaPaket, String deskripsiSingkat, String fitur, String harga, int durasi) {
    ...
    /**
     * Buat record transaksi dan kembalikan id_transaksi yang dihasilkan. Jika
     * gagal mengembalikan -1.
     */
    public static int createTransaksi(Integer userId, int pcId, int paketId, String kodeAcak, String qrKodenya, long durasiMs, int totalHarga) {
        String sql = "INSERT INTO transaksi (id_user, id_pc, id_paket, kode_acak, qr_kode, durasi_ms, total_harga, status) VALUES (?, ?, ?, ?, ?, ?, ?, 'pending')";
    ...
    /**
     * Representasi sesi aktif yang berasal dari tabel transaksi (status =
     * 'pending').
     */
    ...
    /**
     * Ambil semua transaksi yang masih berstatus 'pending' dan kembalikan
     * sebagai daftar sesi aktif dengan perhitungan waktu selesai (created_at +
     * durasi_ms).
     */
    ...
    /**
     * Cari id user berdasarkan username. Kembalikan null jika tidak ditemukan.
     */
    ...
    /**
     * Update status PC (mis. 'available', 'in-use', 'maintenance').
     */
